...
import type { SliderBlockElement } from '../types'

export function SliderElement(props: PlateElementProps<SliderBlockElement>) {
  ...
  return (
    <PlateElement {...props}>
      <DirectiveWrapper label="Slider" color="void">
        <div contentEditable={false} className="flex items-center gap-2">
          <span className="text-xs text-gray-500">Slider-Slug:</span>
          <input
            type="text"
            value={slug}
